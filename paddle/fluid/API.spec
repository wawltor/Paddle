...
paddle.fluid.layers.scatter (ArgSpec(args=['input', 'index', 'updates', 'name', 'mode'], varargs=None, keywords=None, defaults=(None, 'overwrite')), ('document', '6aeb71dabcb1070e23ca90d89cb5f303'))
